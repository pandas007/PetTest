...
import com.pandasby.pettest.data.repos.DnDSpellsRepositoryImpl
...
abstract class DnDModule {
    ...
    @Binds
    abstract fun bindSpellsRepository(repository: DnDSpellsRepositoryImpl): DnDSpellsRepository
}